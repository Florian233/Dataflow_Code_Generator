 ...
 */
std::string parse_command_line_input_function_cpp =
"#include \"options.h\"\n"
"#include <string.h>\n"
"#include <iostream>\n"
"\n"
...
std::string parse_command_line_input_function_c =
"#include \"options.h\"\n"
"#include <stdio.h>\n"
"#include <string.h>\n"
"#include <stdlib.h>\n"
...
std::pair<std::string, std::string> generate_ORCC_compatibility_layer(std::string path) {
	...
	if (c->get_target_language() == Target_Language::cpp) {
		filename = "orcc_compatibility.cpp";
	}
	else if (c->get_target_language() == Target_Language::c) {
		filename  = "orcc_compatibility.c";
	}
	tmp /= filename;
	...
	if (c->get_target_language() == Target_Language::cpp) {
		source_file << parse_command_line_input_function_cpp;
	}
	else if (c->get_target_language() == Target_Language::c) {
		source_file << parse_command_line_input_function_c;
	}
	source_file.close();

	return std::make_pair("options.h", filename);
}